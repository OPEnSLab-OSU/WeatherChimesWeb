        ...
        <div class="soundModule" id="module${moduleId}">
            ...
            <div class="rightMenu">
                <div class="moduleTopOptions">
                    <div class="volumeContainer">
                        <label>Volume:</label>
                        <input type="range" class="right-volume" min="-20" max="20" value="0" step="1">
                    </div>
                </div>
                ...
                <div class="moduleDataOptions">
                    <div class="sensorsContainer">
                        <label>Sensor:</label>
                        <select class="right-sensors"></select>
                    </div>
                    <div class="readingsContainer">
                        <label>Reading:</label>
                        <select class="right-readings"></select>
                    </div>
                </div>

                <button class="right-collapse-btn">
                    Sound Options <span class="arrow-icon">▼</span>
                </button>

                <div class="right-moduleBottomOptions" style="display: none;">
                    <div>
                        <label>Sustain Notes:</label>
                        <input type="checkbox" class="right-sustainNotes" checked>
                        <br /><br />

                        <label>Tonic:</label>
                        <select class="right-tonic">
                            <option value="C">C</option>
                            <option value="C#">C#</option>
                            <option value="D">D</option>
                            <option value="D#">D#</option>
                        ...
                        <select class="right-soundTypes"></select>
                    </div>
                </div>
            </div>
