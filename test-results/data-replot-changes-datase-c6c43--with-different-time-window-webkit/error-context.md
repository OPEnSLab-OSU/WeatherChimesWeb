...
- Name: data-replot.spec.js >> changes dataset then re-retrieves with different time window
- Location: tests\browser\data-replot.spec.js:51:1
...
Call log:
  - waiting for locator('#dataSourceModal') to be visible
    15 × locator resolved to hidden <div class="modal" id="dataSourceModal">…</div>
